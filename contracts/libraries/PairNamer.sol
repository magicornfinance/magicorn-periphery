...
// produces names for pairs of tokens using MagicornSwap's naming scheme
library PairNamer {
    string private constant TOKEN_PAIR_PREFIX = 'MAGIC-LP';
    ...
    // produces a pair symbol in the format of `MAGIC-LP:${symbol0}:${symbol1}${suffix}`
